package com.springbootseccion5.form.app.models.domain;

import java.util.Date;
import java.util.List;

import com.springbootseccion5.form.app.validation.IdentificadorRegex;
import com.springbootseccion5.form.app.validation.Requerido;
